...
final class XmlSignatureDetectorTest extends TestCase
{
    ...
    public static function provideXmlSamples(): iterable
    {
        ...
        yield 'html doctype with omitted html element' => [
            '<!doctype html><meta charset="utf-8"><p>hello',
            'html',
            'text/html',
        ];
        yield 'svg doctype with internal subset' => [
            '<!doctype svg [<!ENTITY label "a > b">]><svg><text>&label;</text></svg>',
            'svg',
            'image/svg+xml',
        ];
